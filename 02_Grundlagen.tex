...
Insbesondere für einen Java- oder C++-Entwickler sehr ungewohnt sein dürfte die Tatsache, dass in
...
\todotext{Beispiel CGI, Webserverzwang, Standard benötigt}

\subsection{Interface}

\todotext{Beispiel Plain WSGI, WSGI-Interface}

\subsection{Verbreitung}

\todotext{Unterstützung in Frameworks, Webservern}
