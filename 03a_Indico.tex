...
Beispielsweise führt ein Aufruf von \emph{/index.py/foo} zum Aufruf der Funktion \lstinline{foo()}
...
um eine Python-Objektdatenbank handelt. Dies erlaubt es, auch komplexe Datentypen wie Python-Module
direkt in der Datenbank zu speichern statt explizit den Pfad zur dazugehörigen Python-Datei
abzulegen.
